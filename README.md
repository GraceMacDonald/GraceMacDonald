...
🔗 Live: https://gracemacdonald.github.io/motivation-generator/  
💻 Repo: https://github.com/GraceMacDonald/motivation-generator  

A JavaScript app that generates motivational messages with unique colours and no repetition using shuffle logic.
...
- Git & GitHub workflow
- Excel, Python & SQL data cleansing and analysis
...
- Build on my Data Analyst profile
- Transition into a combined Data Analyst, Software Developer role
...
<!--
**GraceMacDonald/GraceMacDonald** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
